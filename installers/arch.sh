...
sudo dconf write /org/gnome/desktop/interface/font-name "'DevaVu Sans 8'"
sudo dconf write /org/gnome/desktop/interface/monospace-font-name "'SauceCodePro Nerd Font 11'"
